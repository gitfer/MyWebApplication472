...
namespace JSport.Lucene.Net.Analysis.En
{
    internal class PorterStemmer
    {
        ...
        {
            if (b.Length <= i)
                Array.Resize<Char>(ref b, i + 1);
            //b = Lucene.Net.Util.ArrayUtil.Grow(b, i + 1);
            b[i++] = ch;
        }
        ...
        */
        ...
        public virtual bool Stem(char[] wordBuffer, int offset, int wordLen)
        {
            ...
            if (b.Length < wordLen)
            {
                Array.Resize<Char>(ref b, wordLen - b.Length);
                //b = new char[Lucene.Net.Util.ArrayUtil.oversize(wordLen, NUM_BYTES_CHAR)];
            }
